...
# (str) Заголовок приложения
title = ballon_calc

# (str) имя пакета
package.name = ballon_calc
...
# (str) варианты ориентации экрана (one of landscape, sensorLandscape, portrait or all)
orientation = all
...
# (str) Выбрать разрядность процессора: armeabi-v7a, arm64-v8a, x86, x86_64
